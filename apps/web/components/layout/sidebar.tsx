...
const navItems: NavItem[] = [
  ...
  { title: 'นัดหมาย & ปฏิทิน', href: '/appointments', icon: Calendar, badge: '8', allowedRoles: ['TENANT_OWNER', 'TENANT_ADMIN', 'BRANCH_MANAGER', 'GROOMER', 'VETERINARIAN', 'RECEPTIONIST', 'STAFF'] },
  { title: 'คิวกรูมมิ่ง (Queue)', href: '/grooming/queue', icon: Scissors, badge: '5', allowedRoles: ['TENANT_OWNER', 'TENANT_ADMIN', 'BRANCH_MANAGER', 'GROOMER', 'RECEPTIONIST', 'STAFF'] },
  { title: 'ตรวจรักษา (Clinical)', href: '/clinical', icon: Stethoscope, badge: 'OPD', allowedRoles: ['TENANT_OWNER', 'TENANT_ADMIN', 'VETERINARIAN', 'RECEPTIONIST'] },
  { title: 'ลูกค้า & สัตว์เลี้ยง', href: '/customers', icon: Users, allowedRoles: ['TENANT_OWNER', 'TENANT_ADMIN', 'BRANCH_MANAGER', 'GROOMER', 'VETERINARIAN', 'RECEPTIONIST', 'STAFF'] },
  ...
  { title: 'คลังสินค้า (Stock)', href: '/inventory', icon: Package, allowedRoles: ['TENANT_OWNER', 'TENANT_ADMIN', 'BRANCH_MANAGER', 'VETERINARIAN', 'RECEPTIONIST', 'STAFF'] },
