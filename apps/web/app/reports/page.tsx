...
const REPORT_MODULES = [
  ...
  {
    title: 'รายงานประสิทธิภาพช่างและพนักงาน (Staff Productivity)',
    description: 'จำนวนสัตว์เลี้ยงที่ให้บริการ ความพึงพอใจ และส่วนแบ่งค่าคอมมิชชัน',
    href: '/reports/no-show',
    icon: Scissors,
    ...
    badge: 'Phase 10',
    stats: 'ชั่วโมงบริการ • Commission Tracker',
  },
  {
